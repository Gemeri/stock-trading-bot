...
def compute_labels(df, mode='momentum', n_ahead=2, thresh=0.002, quantile=0.4):
    ...
    # Use close-to-close forward return so all models share the same
    # orientation.  Previously this used open->future close returns which
    # made its labels incompatible with the meta model.
